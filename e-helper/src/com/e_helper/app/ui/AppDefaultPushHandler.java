...
public class AppDefaultPushHandler extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.app_default_push);
	...
	private void loadMessage() {
		...
		query.whereEqualTo("messageType", "default");
		...
		query.findInBackground(new FindCallback<Message>() {
			...
			public void done(List<Message> arg0, AVException arg1) {
				// TODO Auto-generated method stub
				if (arg0.size() == 0) {
					AppDefaultPushHandler.this.finish();
					return;
				}
				message= arg0.get(0);
				if (null != message) {
