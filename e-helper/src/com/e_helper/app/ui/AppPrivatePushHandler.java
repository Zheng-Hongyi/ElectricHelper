...
public class AppPrivatePushHandler extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.app_private_push);
		initializeUI();
		loadMessage();
	}
	...
	private void loadMessage() {
		...
		query.whereEqualTo("messageType", "private");
		...
		query.findInBackground(new FindCallback<Message>() {
			...
			public void done(List<Message> arg0, AVException arg1) {
				// TODO Auto-generated method stub
				if (arg0.size() == 0) {
					AppPrivatePushHandler.this.finish();
					return;
				}
				message= arg0.get(0);
				if (null != message) {
